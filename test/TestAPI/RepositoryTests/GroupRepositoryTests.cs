...
public class GroupRepositoryTests
{
  ...
  public void SetUp()
  {
    ...
    this._groupRepository = new GroupRepository(this._studentContext,
      new RequestRepository(this._studentContext,
      ...
      new GroupStudentRepository(this._studentContext));
  }
