...
public class FRDOModel
{
  ...
  ///   Статус документа.
  /// </summary>
  public string? StatusDocument { get; set; } = "Оригинал";

  /// <summary>
  ///   Подтверждение утраты.
  /// </summary>
  public string? ConfirmationLoss { get; set; } = "Нет";

  /// <summary>
  ///   Подтверждение обмена.
  /// </summary>
  public string? ConfirmationExchange { get; set; } = "Нет";

  /// <summary>
  ///   Подтверждение уничтожения.
  /// </summary>
  public string? ConfirmationDestruction { get; set; } = "Нет";
  ...
  /// </summary>
  public string? NameFieldProfessionalActivity { get; set; } = "Связь, информационные и коммуникационные технологии";

  /// <summary>
  ///   Укрупненные группы специальностей.
  /// </summary>
  public string? EnlargedGroupsSpecialties { get; set; } = "информатика и вычислительная техника";
  ...
  /// </summary>
  public string? RecipientDateBirth { get; set; }
  ...
  /// </summary>
  public string? FormEducationAtTimeTerminationEducation { get; set; } = "в образовательной организации";

  /// <summary>
  ///   Гражданство получателя (код страны по ОКСМ).
  /// </summary>
  public string? RecipientCitizenship { get; set; } = "643";

  /// <summary>
  ///   Наименование документа об образовании (оригинала).
  /// </summary>
  public string? NameDocumentEducationOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Серия (оригинала).
  /// </summary>
  public string? SeriesOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Номер (оригинала).
  /// </summary>
  public string? NumberOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Регистрационный N (оригинала).
  /// </summary>
  public string? RegistrationNumberOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Дата выдачи (оригинала).
  /// </summary>
  public string? DateIssueOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Фамилия получателя (оригинала).
  /// </summary>
  public string? RecipientLastNameOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Имя получателя (оригинала).
  /// </summary>
  public string? RecipientNameOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Отчество получателя (оригинала).
  /// </summary>
  public string? RecipientPatronymicOriginalDocument { get; set; } = string.Empty;

  /// <summary>
  ///   Номер документа для изменения.
  /// </summary>
  public string? NumberDocumentToChange { get; set; } = string.Empty;
}