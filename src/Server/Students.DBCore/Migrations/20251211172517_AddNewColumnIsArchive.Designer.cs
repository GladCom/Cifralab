...
namespace Students.DBCore.Migrations
{
    ...
    [Migration("20251211172517_AddNewColumnIsArchive")]
    partial class AddNewColumnIsArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Students.Models.EducationProgram", b =>
                {
                    ...
                    b.Property<Guid>("KindEducationProgramId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("KindEducationProgramId");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KindDocumentRiseQualificationId = new Guid("aa7a8325-4b0d-4dd2-bedc-2c4a065ab332"),
                            KindEducationProgramId = new Guid("a359d390-c3d8-45ed-a775-9e3fde156d78"),
                            Name = "Академия цифра",
                            QualificationName = ""
                        });
                });
            ...
            modelBuilder.Entity("Students.Models.PhantomStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Students.Models.ReferenceModels.KindEducationProgram", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("KindEducationPrograms");
            ...
            modelBuilder.Entity("Students.Models.Request", b =>
                {
                    ...
                    b.Property<Guid?>("PhantomStudentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfCreate = new DateTime(2025, 12, 11, 22, 25, 16, 539, DateTimeKind.Local).AddTicks(6918),
                        ...
                        new
                        {
                            ...
                            DateOfCreate = new DateTime(2025, 12, 11, 22, 25, 16, 541, DateTimeKind.Local).AddTicks(3157),
            ...
            modelBuilder.Entity("Students.Models.EducationProgram", b =>
                {
                    ...
                    b.HasOne("Students.Models.ReferenceModels.KindEducationProgram", "KindEducationProgram")
                        .WithMany()
                        .HasForeignKey("KindEducationProgramId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("KindEducationProgram");
                });
            ...
            modelBuilder.Entity("Students.Models.Request", b =>
                {
                    ...
                    b.HasOne("Students.Models.PhantomStudent", "PhantomStudent")
                        .WithOne()
                        .HasForeignKey("Students.Models.Request", "PhantomStudentId");
