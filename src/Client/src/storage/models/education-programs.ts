...
const model = {
  ...
  hoursCount: { name: 'Количество часов', type: HoursCount, show: true, required: true },
  educationFormId: { name: 'Форма обучения', type: EducationFormSelect, show: true, required: true },
  kindEducationProgramId: { name: 'Вид программы', type: KindEducationProgramSelect, show: true, required: true },
  cost: { name: 'Стоимость обучения', type: Cost, show: true, required: true },
