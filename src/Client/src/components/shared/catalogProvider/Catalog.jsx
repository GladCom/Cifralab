...
const Catalog = ({ config }) => {
    const { fields, properties, detailsLink, crud, hasDetailsPage, columns } = config;
    ...
    useEffect(() => {
        if (!isLoading && !isFetching) {
            const normalizedData = hasDetailsPage ? dataFromServer?.data : dataFromServer;
            const total = hasDetailsPage ? dataFromServer?.totalCount : dataFromServer?.length;
