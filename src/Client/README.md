...
3) Установите необходимые зависимости: выполните команду `npm i` (все необходимые скрипты расположены в файле [package.json](./src/Client/package.json))
...
5) Запустите приложение: выполните команду `npm start` - Webpack запустит локальный сервер по адресу [localhost:3000](url) и откроет в браузере страницу приложения (если не откроет, откройте сами)
